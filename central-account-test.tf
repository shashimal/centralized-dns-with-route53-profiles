#######################################################
# Lambda function for testing the shared vpc interface endpoint in central account
#####################################################
module "test_function_in_central_account" {
  source  = "terraform-aws-modules/lambda/aws"
  version = "~> 7.1"

  function_name = "test-function-in-central-account"
  description   = "Test function in the central account"
